...
\todo[inline]{The way you wrote this was very confusing and you used the notion $A^+$ with the $X$ matrix which will be defined only later. I changed this to the original setting. If you are not happy with it we can discuss it.}
%\begin{align*}
