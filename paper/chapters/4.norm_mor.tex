...
\end{equation}
Since we are free to choose the basis $U$, we require $U = X^{1/2} (\tilde A^+)^T$ so that the complex expression in (\ref{eq:normmor.16}) reduces to
