...
\begin{equation} \label{eq:normmor.14.3}
	\dot y = -\mathbb J_{2k} \nabla_{ y} H_X(\tilde A y).
\end{equation}
This is a Hamiltonian function identified by the reduced Hamiltonian $-\nabla_{ y} H_X(\tilde A y)$. The reduced system yields
